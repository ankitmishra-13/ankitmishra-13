...
<p align="center">
Full Stack Developer based in Mumbai, India, building SaaS, AI, and document products across frontend, APIs, data, and cloud delivery.
</p>

<p align="center">
  <a href="https://ankitm.dev"><img src="https://img.shields.io/badge/Portfolio-ankitmishra.dpdns.org-090a0a?style=for-the-badge" /></a>
...
- 💼 Full Stack Developer at **Digitrix Agency**

## What I work on

I move between interface decisions, backend constraints, and release work so the shipped product holds together — from React/Next.js frontends to FastAPI/Node backends, payments, auth, and cloud delivery on AWS, DigitalOcean, and Cloudflare.
...
![OAuth](https://img.shields.io/badge/-OAuth%202.0-3C4858?style=flat-square)
...
- 45% faster database responses through indexing and aggregation optimization
- 40% less manual release effort via GitHub Actions CI/CD
- 35% fewer post-release defects through code-review standards
- 25% engagement lift and Lighthouse scores raised from 65 to 90+
- 15% increase in checkout conversion via Stripe/Razorpay integration

---

📫 Reach me at [ankitrm4@gmail.com](mailto:ankitrm4@gmail.com) or on [LinkedIn](https://www.linkedin.com/in/ankit-mishra-74b070245/)
